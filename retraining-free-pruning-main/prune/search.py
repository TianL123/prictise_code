...
def search_mac(
    ...
    max_mac = mac_constraint * original_mac #保留的mac 在这个资源下 保留的神经元重要性最大

    head_importance = compute_fisher_info(head_grads) #12,12
    neuron_importance = compute_fisher_info(neuron_grads) #12,3072

    # Globally rank heads and neurons 降序
